...
def submit():
    if request.method == "POST":
        ...
        if model == 'knn':
            ...
            y_train_predict = jb.load('knn_pred.pkl')
            ...
            y_train_predict = jb.load('y_train_predict.pkl')
            predictions = loaded_model.predict(int_features).tolist()
            ...
            y_train_predict = jb.load('dct_y_pred.pkl')
            predictions = loaded_model.predict(int_features).tolist()
            ...
            y_train_predict = jb.load('rf_y_pred.pkl')
            predictions = loaded_model.predict(int_features).tolist()
            ...
            y_train_predict = jb.load('lrYpred.pkl')
            predictions = loaded_model.predict(int_features).tolist()
